...
int main(int argc, char **argv){
    ...
    x1 = BN_bn2dec(t3);
    fprintf(stdout,"[A = 1111]-->Recover value is %s\n",x1);
    fflush(stdout);  // 刷新标准输出流
    et_Recover(t3,&b);
    x1 = BN_bn2dec(t3);
    fprintf(stdout,"[B = 2222]-->Recover value is %s\n",x1);
    fflush(stdout);  // 刷新标准输出流
    /*---------Add---------*/
    ...
    et_Recover(t3,&c);
    x1 = BN_bn2dec(t3);
    fprintf(stdout,"3333 * [A = 1111] = C-->Recover value is %s\n",x1);
    fflush(stdout);  // 刷新标准输出流
    /*---------et_Mul-----------*/
